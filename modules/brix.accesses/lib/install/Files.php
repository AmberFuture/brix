...
class Files
{
     ...
     * @var array
     */
    private static $PATHS = ["css", "js", "images"];
    ...
    public static function install()
    {
        ...
        CopyDirFiles($docRoot . "/bitrix/modules/" . self::MODULE_ID . "/install/public/", $docRoot . "/", true, true);
    ...
    public static function uninstall()
    {
        ...
        Directory::deleteDirectory($docRoot . "/brix_accesses/");
